...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = ["6281617620966@c.us"] // replace with your whatsapp number
        ...
        case '!donasi':
        case '!donate':
        client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/BayuBOTZ', donate)
            break
        case '!tts':
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ GLX BOT Broadcast ]\n\n${msg}`)
            }
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, 'https://youtube.com/Bayu+Xploit', info)
            break
        case '!snk':
